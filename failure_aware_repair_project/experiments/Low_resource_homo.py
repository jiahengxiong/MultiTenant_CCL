...
WORKING_MAPPING_SOURCE_CACHE_DIR = Path(
    os.environ.get(
        ...
        "/private/tmp/low_resource_story_cache",
    )
)
...
SIMULATOR_VALIDATION_CACHE_SCHEMA = "low_resource_homo_sim_validation_v2"
SEED_STORY_CACHE_SCHEMA = "low_resource_homo_seed_story_v3"
